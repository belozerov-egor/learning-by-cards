...
import { Button, Card, RadioGroupDemo, Typography } from '../../components'
import { useGetDeckQuery, useLearnDeckQuery, useUpdateGradeCardMutation } from '../../services'
...
const AnswerPage: FC<PropsType> = ({ answer, answerImg, setNewQuestion }) => {
